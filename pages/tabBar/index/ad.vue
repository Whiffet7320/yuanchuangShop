<template>
	<view class="wanl-advert" :style="{ height: windowHeight + 'px' }">
		...
		<view v-else>
			<image :style="{ height: windowHeight + 'px', width: '100%' }" :src="common.adData.openAdverts.media ? $wanlshop.oss(common.adData.openAdverts.media, 414, 0, 2, 'transparent', 'png') : ''" mode="aspectFill"/>
			<!-- #ifndef MP -->
