...
/* 0 */
/*!**************************************************************!*\
  !*** C:/Users/Administrator/Desktop/wanlshop_v1.0.8/main.js ***!
  \**************************************************************/
...
_vue.default.prototype.$url = 'https://scht.gycsc.com/api';
...
_request.default.interceptor.request = function (config) {
  ...
  if (!config.header.token || !config.header.wanlshop) {
    var wanlLogin = uni.getStorageSync("wanlshop:user");
    if (wanlLogin) {
...
var wanlsys = function wanlsys() {
  ...
  _config.default.debug ? console.log(data) : '';
  return data;
};
...
var oss = function oss(url) {var w = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 120;var h = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 120;var modenum = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 2;var type = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : '';var format = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 'jpg';var resize = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 'resize';var multiple = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : 3;
  ...
  if (url) {
    if (/^data:image\//.test(url)) {
      ...
      image = _config.default.cdnurl + url + rule.join("/");
    }
  } else {
    if (type == 'transparent') {
...
var on = function on(url) {
  ...
  // 关闭所有页面，跳转链接
  if (url == '/pages/tabBar/index/index' || url == '/pages/tabBar/category/category' || url == '/pages/tabBar/notice/notice' || url == '/pages/tabBar/find/find' || url == '/pages/tabBar/cart/cart' || url == '/pages/tabBar/user/user') {
    uni.switchTab({
      url: url });
...
// 全局店铺链接
_vue.default.prototype.onShop = function (id) {var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';to("/pages/shop/shop?id=".concat(id, "&type=").concat(type));};
...
/* 6 */
/*!**************************************************************!*\
  !*** C:/Users/Administrator/Desktop/wanlshop_v1.0.8/App.vue ***!
  \**************************************************************/
/*! no static exports found */
...
/* 7 */
/*!***************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/wanlshop_v1.0.8/App.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 8 */
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!C:/Users/Administrator/Desktop/wanlshop_v1.0.8/App.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = { onLaunch: function onLaunch() {// 检测客户端更新
    ...
    this.$store.dispatch('statistics/get');}, onShow: function onShow() {// 启动或重启即时通讯
    this.$store.dispatch('chat/start');}, onHide: function onHide() {// 断开即时通讯
    this.$store.dispatch('chat/close');} };exports.default = _default;

/***/ }),
/* 9 */
/*!***********************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/wanlshop_v1.0.8/App.vue?vue&type=style&index=0&lang=css& ***!
  \***********************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
