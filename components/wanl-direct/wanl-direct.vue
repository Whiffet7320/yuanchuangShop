<template>
	<view>
		<view class="wanl-direct">
			...
			<view class="menu-box">
				<view class="menu-item" hover-class="wanl-opcity" @tap="$wanlshop.on('/pages/tabBar/notice/notice')">
				...
				<view class="menu-item" hover-class="wanl-opcity" @tap="$wanlshop.on('/pages/tabBar/index/index')">
					<view class="badge-box">
						<text class="wlIcon-31shouye"></text>
					</view>
					<view class="menu-text">首页</view>
				</view>
				<view class="menu-item" hover-class="wanl-opcity" @tap="$wanlshop.on('/pages/tabBar/user/user')">
					<view class="badge-box">
				...
				<view class="menu-item" hover-class="wanl-opcity" @tap="$wanlshop.on('/pages/tabBar/cart/cart')">
					<view class="badge-box">
